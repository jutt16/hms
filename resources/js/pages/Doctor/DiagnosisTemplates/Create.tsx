...
interface DiagnosisTemplatesCreateProps extends PageProps {}

export default function Create({}: DiagnosisTemplatesCreateProps) {
    return (
        <AuthenticatedLayout title="Create Diagnosis Template">
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-white dark:bg-gray-800 shadow rounded-lg">
                    <div className="px-4 py-5 sm:p-6">
                        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Create Diagnosis Template</h2>

                        <Form
                            action="/doctor/diagnosis-templates"
                            method="post"
                            className="space-y-6"
                        >
                            {({ errors, processing }) => (
                                <>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            placeholder="e.g., Common Cold Diagnosis"
                                        />
                                        {errors.name && (
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            rows={8}
                                            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm"
                                            placeholder="Enter diagnosis details, symptoms, findings, etc."
                                        />
                                        {errors.diagnosis && (
