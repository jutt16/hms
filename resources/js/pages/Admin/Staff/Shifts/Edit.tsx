...
interface ShiftsEditProps extends PageProps {
    shift: Shift;
}

export default function Edit({ shift }: ShiftsEditProps) {
    return (
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-white dark:bg-gray-800 shadow rounded-lg">
                    <div className="px-4 py-5 sm:p-6">
                        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Edit Shift</h2>

                        <Form
                            action={`/admin/staff/shifts/${shift.id}`}
                            method="put"
                            className="space-y-6"
                        >
                            {({ errors, processing }) => (
