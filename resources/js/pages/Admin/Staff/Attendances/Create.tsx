...
interface AttendancesCreateProps extends PageProps {
    staff: Staff[];
    shifts: Shift[];
    selectedStaff: Staff | null;
}

export default function Create({ staff, shifts, selectedStaff }: AttendancesCreateProps) {
    const urlParams = new URLSearchParams(window.location.search);
    const staffId = urlParams.get('staff_id');

    return (
        <AuthenticatedLayout title="Record Attendance">
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-white dark:bg-gray-800 shadow rounded-lg">
                    <div className="px-4 py-5 sm:p-6">
                        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Record Attendance</h2>

                        <Form
                            action="/admin/staff/attendances"
                            method="post"
                            className="space-y-6"
                        >
                            {({ errors, processing }) => (
